...
if __name__ == '__main__':
    ...
    for nb in [10]:
        ...
        df_pos = pd.read_pickle(f'../session_rec_sigir_data/prepared/train_pos_nb{nb}_fail.pkl')
        df_neg = pd.read_pickle(f'../session_rec_sigir_data/prepared/train_neg_nb{nb}_fail.pkl')
        ...
        Data.dump(X_train.drop(['product_sku_hash_list', 'product_action_list', 'label_max'], axis=1),
                  f'../input/pickle/X_train_nb{nb}_fail.pkl')
        Data.dump(X_train['label_max'], f'../input/pickle/y_train_nb{nb}_fail.pkl')
        Data.dump(
            X_test_nb.drop([
                'session_id_hash_',
                'nb_after_add_max',
            ...
            f'../input/pickle/X_test_nb{nb}_fail.pkl'
        )
